...
class TimeSlotTableViewCell: UITableViewCell {
    ...
    fileprivate func selectCell(forIndexPath indexPath: IndexPath) {
        ...
        //select
        if let cell = timeSlotCollectionView.cellForItem(at: indexPath) as? TimeSlotCollectionViewCell {
...
extension TimeSlotTableViewCell: UICollectionViewDataSource {
...
extension TimeSlotTableViewCell: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: (screenWidth/3)-15, height: 50)
    }
