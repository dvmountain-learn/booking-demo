...
class ServiceTableViewCell: UITableViewCell {
    ...
    fileprivate func selectCell(forIndexPath indexPath: IndexPath) {
        ...
        //select
        if let cell = serviceCollectionView.cellForItem(at: indexPath) as? ServiceCollectionViewCell {
...
extension ServiceTableViewCell: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
